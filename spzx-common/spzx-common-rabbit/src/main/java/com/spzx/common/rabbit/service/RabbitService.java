...
public class RabbitService {
    ...
    public boolean sendMessage(String exchange, String routingKey, Object message) {
        ...
        // 创建自定义相关消息对象-包含业务数据本身，交换器名称，路由键，队列类型，延迟时间,重试次数
        ...
        // 将相关消息存入Redis  Key：UUID  相关消息对象  10 分钟
        redisTemplate.opsForValue().set(uuid, JSON.toJSONString(correlationData), 10, TimeUnit.SECONDS);
